...
(function ($) {
    ...
    SHOPNONSTOP.initScrollUp = function () {
        $.scrollUp({
    ...
    SHOPNONSTOP.initScrollSpy = function () {
    ...
    SHOPNONSTOP.onClickScroll = function () {
    ...
    SHOPNONSTOP.initTooltip = function () {
    ...
    // Bind Modals
    SHOPNONSTOP.initModal = function () {
    ...
    SHOPNONSTOP.defaultAddressCheckbox = function () {
    ...
    SHOPNONSTOP.shopnonstopNavigation = function () {
        $('#navigation').shopNav();
        $('#navigation1').shopNav();
        $('#navigation2').shopNav();
        $('#navigation3').shopNav();
    ...
    SHOPNONSTOP.onTabActiveRefreshSlider = function () {
    ...
    SHOPNONSTOP.primarySlider = function () {
    ...
    // Bind all sliders into the page
    SHOPNONSTOP.productSlider = function () {
    ...
    // Bind all sliders into the page
    SHOPNONSTOP.tabSlider = function () {
    ...
    // Bind Brand slider
    SHOPNONSTOP.brandSlider = function () {
    ...
    // Testimonial Slider
    SHOPNONSTOP.testimonialSlider = function () {
    ...
    SHOPNONSTOP.appConfiguration = function () {
        $('body').removeAttr('class');
        $('.preloader').removeClass('is-active');
    };

    // Bind isotope filter plugin
    SHOPNONSTOP.isotopeFilter = function () {
    ...
    SHOPNONSTOP.timerCountDown = function () {
    ...
    // Input Counter
    SHOPNONSTOP.initInputCounter = function () {
    ...
    // Blog Post Gallery
    SHOPNONSTOP.blogPostGallery = function () {
    ...
    // Blog Post Masonry
    SHOPNONSTOP.blogPostMasonry = function () {
    ...
    // Blog Post Video
    SHOPNONSTOP.blogPostVideo = function () {
    ...
    SHOPNONSTOP.blogPostEmbedVideo = function () {
    ...
    // Product Detail Init
    SHOPNONSTOP.productDetailInit = function () {
    ...
    SHOPNONSTOP.modalProductDetailInit = function () {
    ...
    SHOPNONSTOP.shopCategoryToggle = function () {
    ...
    SHOPNONSTOP.shopPerspectiveChange = function () {
    ...
    SHOPNONSTOP.shopSideFilter = function () {
    ...
    SHOPNONSTOP.showNewsletterModal = function () {
    ...
    $(window).on('load', function () {
        SHOPNONSTOP.showNewsletterModal();
        if ($primarySlider.length) {
    ...
    SHOPNONSTOP.initScrollUp();
    SHOPNONSTOP.initTooltip();
    SHOPNONSTOP.initModal();
    SHOPNONSTOP.defaultAddressCheckbox();
    SHOPNONSTOP.initScrollSpy();
    SHOPNONSTOP.onClickScroll();
    SHOPNONSTOP.shopnonstopNavigation();
    SHOPNONSTOP.primarySlider();
    SHOPNONSTOP.productSlider();
    SHOPNONSTOP.tabSlider();
    SHOPNONSTOP.onTabActiveRefreshSlider();
    SHOPNONSTOP.brandSlider();
    SHOPNONSTOP.testimonialSlider();
    SHOPNONSTOP.appConfiguration();
    SHOPNONSTOP.isotopeFilter();
    SHOPNONSTOP.timerCountDown();
    SHOPNONSTOP.initInputCounter();
    SHOPNONSTOP.blogPostGallery();
    SHOPNONSTOP.blogPostVideo();
    SHOPNONSTOP.blogPostEmbedVideo();
    SHOPNONSTOP.blogPostMasonry();
    SHOPNONSTOP.productDetailInit();
    SHOPNONSTOP.modalProductDetailInit();
    SHOPNONSTOP.shopCategoryToggle();
    SHOPNONSTOP.shopPerspectiveChange();
    SHOPNONSTOP.shopSideFilter();
})(jQuery);